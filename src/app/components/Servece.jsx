  ...
  return (
    <div class="">
      <div class="text-center">
        <h1
          class="text-orange-400 font-bold text-6xl z-0 
      opacity-25 "
        >
          DevTech
        </h1>
        <h1 class="text-3xl  left-[45%]  font-bold text-[#0e385e] z-1 ">
          our services
        </h1>
      ...
      <div
        class="grid md:grid-cols-3 max-w-screen-lg mx-auto gap-10
     mt-16 px-5 pb-20 "
      >
        ...
        <div
         ...
         "
          >
          <span class="text-orange-400 bg-orange-400/20 p-3 rounded-full">
            <svg
              width="15"
              height="15"
              viewBox="0 0 15 15"
        ...
        <div
          class="flex gap-4 items-start
        flex-col shadow-xl text-center justify-center
        p-10"
        >
          <div
            class="flex gap-4 items-start
